...
const LANDMARK_ALIASES = [
  ...
  // Generic words commonly attached to a proper-noun landmark ("X Plaza",
  // "Y Market", "Z Gate") — combined with the proper-noun aliases above, this
  // recovers most two-word English landmark names without needing every
  // combination spelled out individually.
  ["plaza", "ပလာဇာ"],
  ["market", "ဈေး"],
  [" zay", "ဈေး"],
  ["gate", "ဂိတ်"],
